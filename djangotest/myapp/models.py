...
class SalesInvoice(models.Model):
    ...
    # ERD indicates a car can appear on at most one invoice.
...
class PartsUsed(models.Model):
    ...
    part = models.ForeignKey(Parts, on_delete=models.CASCADE, related_name="parts_used_records")
    service_ticket = models.ForeignKey(ServiceTicket, on_delete=models.CASCADE, related_name="parts_used_records")
